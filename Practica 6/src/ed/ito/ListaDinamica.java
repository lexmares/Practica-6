...
public class ListaDinamica<E> implements Lista<E> , Serializable{
	...
	@Override
	public E delete(int i) throws ExcepcionDeListaVacia, ExcepcionDeElementoNoEncontrado, NullPointerException {
		// TODO Auto-generated method stub
		if(this.isEmpty())
	...
	@Override
	public E deleteItem(E item) throws ExcepcionDeListaVacia, ExcepcionDeElementoNoEncontrado, NullPointerException {
		// TODO Auto-generated method stub
		if(this.isEmpty())
			throw new ExcepcionDeListaVacia("La lista esta vacia!!");
	...
	@Override
	public E getItem(int i) throws ExcepcionDeListaVacia, ExcepcionDeElementoNoEncontrado, NullPointerException {
		// TODO Auto-generated method stub
		if(this.isEmpty())
			throw new ExcepcionDeListaVacia("La lista esta vacia!!");
		if(i>this.size)
